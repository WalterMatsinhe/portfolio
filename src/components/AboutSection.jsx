      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground ">
            With over years of experience in web development , I socialize in
            creating responsive and accessible web applications using modern
            technologies.
          </p>
          <p className="text-muted-foreground">
            🎓 I'm a Computer Science student passionate about coding and
            technology. 💻 I work with Java, CSS, React, HTML, and MySQL to
            build responsive, functional, and efficient applications. 🌱
            Currently, I'm diving deeper into full-stack development and
            enhancing my problem-solving skills. 🚀 Let's connect and create
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="relative gradient-border p-6 card-hover">
            <div className="flex items-start gap-4">
              ...
              <div className="relative text-left">
                ...
                <p className="text-muted-foreground">
                  Creating Resonsive websites and web applications with modern
                  frameworks
                </p>
              </div>
            </div>
